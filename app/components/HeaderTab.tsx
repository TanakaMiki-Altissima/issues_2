...
export function HeaderTab() {
  ...
  <div className="flex flex-col items-center w-7 h-7">
    ...
    />
    <p className="text-[9px] text-blue-700 font-semibold whitespace-nowrap">スケジュール</p>
  </div>
  <div className="flex flex-col items-center w-7 h-7">
    <img
  ...
  <div className="flex flex-col items-center w-7 h-7">
    ...
    />
    <p className="text-[9px] text-blue-700 font-semibold whitespace-nowrap">Eラーニング</p>
  </div>
  <div className="flex flex-col items-center w-7 h-7">
    <img
  ...
  <div className="flex flex-col items-center w-7 h-7">
    ...
    <p className="text-[9px] text-blue-700 font-semibold whitespace-nowrap">設計図</p>
      ...
      <div className="flex h-2 items-center overflow-hidden bg-blue-600 shadow-[0_4px_12px_rgba(0,0,0,0.2)]">
        <button
          type="button"
          onClick={() => setIsMenuOpen((prev) => !prev)}
          className="flex w-20 items-center justify-center bg-sky-500 text-gray-200 hover:text-white"
